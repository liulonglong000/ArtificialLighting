	        	...
	        	<div class="content_border">
	            	<div class="table_title">
	                	<div class="table_content">
	                    	<span class="table_title_box">修改网关信息</span>
	                    </div>
	                </div>
	                <div class="table_content">
							...
							<tr>
	    						<td colspan="2">
	                            	<div class="radio_box" style="height:40px; margin:20px 0 20px 20px;">
	                                	<a href="javascript:;" onclick="toSaveGatewayInfo('gateway/mdyGatewayInfo', '修改网关信息成功！', false);" class="btn_box">修&nbsp;&nbsp;&nbsp;改</a>
	                                	<a href="gatewayJsp/webQueryGwTable?userId=<%=sessionInfo.getUserIdString() %>" class="btn_box">返&nbsp;&nbsp;&nbsp;回</a>
	                                </div>
	                            </td>
	  						</tr>
						</table>	
