	        	...
	        	<div class="content_border">
	            	<div class="table_title">
	                	<div class="table_content">
	                    	<span class="table_title_box">修改节点信息</span>
	                    </div>
	                </div>
	                <div class="table_content">
	                <form id="fileForm" method="post" enctype="multipart/form-data">
						...
						<table width="100%" border="0">							
						  	<tr class="tr_style">
							    <td style="text-align: right; width: 160px;">名    称：</td>
						  	...
						  	<tr class="tr_style">
							    <td style="text-align: right;">采集频率(分钟)：</td>
							    <td><input class="input_txt5" id="frquencyId" name="frquency" onkeyup="value=value.replace(/[^\d]/g,'')" onBlur="limitInputForInt(this, '面积');"  style="ime-mode:Disabled;" type="text" value="<%=gwInfo.getFrequencyData() %>"/></td>
						  	</tr>
						  	<tr class="tr_style">
							...
							<tr>
	    						<td colspan="2">
	                            	<div class="radio_box" style="height:40px; margin:20px 0 20px 20px;">
	                                	<a href="javascript:;" onclick="toSaveNodeInfo();" class="btn_box">修&nbsp;&nbsp;&nbsp;改</a>
	                                	<a href="gatewayJsp/webQueryNode?ghId=<%=gwInfo.getGhId() %>" class="btn_box">返&nbsp;&nbsp;&nbsp;回</a>
	                                </div>
	                            </td>
	  						</tr>
						</table>	
