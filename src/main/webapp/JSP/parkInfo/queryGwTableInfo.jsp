<%@ page language="java" import="java.util.*, com.face.entity.UserInfo, com.face.dto.UserRole, com.face.model.Session, com.face.entity.GatewayInfo" pageEncoding="UTF-8"%>
<%
			    ...
			    <div class="content_border" style="margin-bottom:16px;">
	            	<div class="table_title">
	                	<div class="table_content">		
	                    	<span class="table_title_box">网关信息</span>
	                    </div>
	                </div>
	                <div class="table_content">
	                	<table width="100%" border="0">
	  						<tr class="tr_style">
	    						...
	    						<td nowrap="nowrap">网关ID</td>
	                            <td nowrap="nowrap">名称</td>
	                            <td nowrap="nowrap">布放位置</td>
	                            <td nowrap="nowrap">录入时间</td> 
	                            <td nowrap="nowrap">描述</td>
	                            <td nowrap="nowrap">最后一次连接时间</td>    
							...
							int nId = 1;
	                		if (listInfo != null) {
	                		for (GatewayInfo entity : listInfo) {   
			               	%>
	  						<tr class="tr_style">
	    						<td><%=nId%><%nId++;%></td>
	    						<td nowrap="nowrap"><%=entity.getGatewayId() %></td>
				                <td nowrap="nowrap"><%=entity.getGatewayName() %></td>
				                <td style="text-align: left;" nowrap="nowrap"><%=entity.getGatewayAddr() %></td>
				                <td nowrap="nowrap"><%=entity.getInDate() %></td>
				                <td style="text-align: left;" nowrap="nowrap"><%=entity.getRemark() %></td>
				                <td nowrap="nowrap"><%=entity.getLastConnectTime() %></td>
	                            <td nowrap="nowrap">
	                            	<a href="gatewayJsp/webGetGatewayInfo?gatewayId=<%=entity.getGatewayId() %>">修改</a>
	                            </td>
	  						</tr>
	  						<%
	  							}
